    ...
    if 'prompt' in request.form:
        ...
        if is_url(prompt):
            ...
            if prompt:
                ...
                headers = {"Authorization": "Bearer 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"}
                ...
                hate_speech = [{'label': label_mapping[result['label']], 'score': result['score']} for result in output[0]]
                print(hate_speech)
